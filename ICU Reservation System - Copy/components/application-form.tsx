  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error) {
        ...
        toast.error(`Failed to submit application: ${error.message || 'Unknown error'}`)      } else {
            ...
            <div className="space-y-4">              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  className={`bg-black/50 border-border/50 text-foreground min-h-[100px] ${
                    fieldErrors.studioUsagePurpose ? 'border-red-500 focus:border-red-500' : ''
                  }`}
                />
                {fieldErrors.studioUsagePurpose && (
                  <p className="text-sm text-red-500 mt-1">{fieldErrors.studioUsagePurpose}</p>
                )}
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  required
                  className={`bg-black/50 border-border/50 text-foreground min-h-[120px] ${
                    fieldErrors.aboutYourself ? 'border-red-500 focus:border-red-500' : ''
                  }`}
                />
                {fieldErrors.aboutYourself && (
                  <p className="text-sm text-red-500 mt-1">{fieldErrors.aboutYourself}</p>
                )}
              </div>
                <div className="space-y-2">
                ...
                <Textarea
                  ...
                  required
                  className={`bg-black/50 border-border/50 text-foreground min-h-[120px] ${
                    fieldErrors.whyJoinStudio ? 'border-red-500 focus:border-red-500' : ''
                  }`}
                />
                {fieldErrors.whyJoinStudio && (
                  <p className="text-sm text-red-500 mt-1">{fieldErrors.whyJoinStudio}</p>
                )}
              </div>
